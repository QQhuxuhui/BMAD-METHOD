...
<!-- Module ID: bmad/aps/templates/domain-library/supply-chain/VMI协同库存管理.md -->
<!-- Aliases: @backend/knowledge_base/aps/domain-library/supply-chain/VMI协同库存管理.md, @backend/knowledge_base/aps/domain-library/供应链调度/VMI协同库存管理.md -->
<!-- Version: v1.0 -->
